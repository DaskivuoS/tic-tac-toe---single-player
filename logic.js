...
function refresh()
{
    ...
    document.getElementById("one").innerHTML = "tictactoe";
    document.getElementById("one").style.color = "transparent";
    document.getElementById("two").innerHTML = "tictactoe";
    document.getElementById("two").style.color = "transparent";
    document.getElementById("three").innerHTML = "tictactoe";
    document.getElementById("three").style.color = "transparent";
    document.getElementById("four").innerHTML = "tictactoe";
    document.getElementById("four").style.color = "transparent";
    document.getElementById("five").innerHTML = "tictactoe";
    document.getElementById("five").style.color = "transparent";
    document.getElementById("six").innerHTML = "tictactoe";
    document.getElementById("six").style.color = "transparent";
    document.getElementById("seven").innerHTML = "tictactoe";
    document.getElementById("seven").style.color = "transparent";
    document.getElementById("eight").innerHTML = "tictactoe";
    document.getElementById("eight").style.color = "transparent";
    document.getElementById("nine").innerHTML = "tictactoe";
